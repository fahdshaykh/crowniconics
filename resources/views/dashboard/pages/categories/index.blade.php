                                ...
                                <tbody>
                                    @forelse($categories as $category)
                                        <tr>
                                                ...
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="category-info">
                                                        ...
                                                        <p class="mb-0 text-secondary">
                                                            {{ Str::limit($category->description, 40) }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge {{ $category->status->value ? 'bg-success' : 'bg-danger' }}">
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <form action="{{ route('categories.toggle-status', $category->id) }}"
                                                        ...
                                                        @method('PATCH')
                                                        <button type="submit"
                                                            class="btn btn-sm btn-outline-{{ $category->status->value ? 'warning' : 'success' }}"
                                                            title="{{ $category->status->value ? 'Deactivate' : 'Activate' }}">

                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                                class="feather feather-{{ $category->status->value ? 'pause' : 'play' }}">
                        ...
                        @if ($categories->hasPages())
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                <div class="text-muted">
                                    ...
                                    of {{ $categories->total() }} categ$categories
                                </div>
