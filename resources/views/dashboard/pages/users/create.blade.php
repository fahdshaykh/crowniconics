           ...
           <div class="col-10 col-xl-10">
            <div class="card rounded-4 border-top border-4 border-primary border-gradient-1">
              <div class="card-body p-4">
                ...
                <form class="row g-4" method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div id="professional-fields" style="display: none;">
                            ...
                            <select name="service_id" id="service_id"
                                ...
                                @foreach ($services as $service)
                                    <option value="{{ $service->id }}"
                                        {{ old('service_id', $user->professionals->service_id ?? '') == $service->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="experience_years" name="experience_years"
                                    value="{{ old('experience_years') }}" placeholder="Enter Years">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control @error('personal_information') is-invalid @enderror" 
                                    ...
                                    placeholder="Personal information ..." rows="4" cols="4">{{ old('personal_information') }}</textarea>
