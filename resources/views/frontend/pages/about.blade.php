        ...
        <div class="ul-inner-page-content-wrapper">
                    ...
                    <div class="ul-partners-slider swiper">
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset('assets') }}/img/partner-1.png" alt="Parter Logo">
                            </div>
                            <!-- single slide -->
                            <div class="swiper-slide">
                                <img src="{{ asset('assets') }}/img/partner-2.png" alt="Parter Logo">
                            </div>
                            <!-- single slide -->
                            <div class="swiper-slide">
                                <img src="{{ asset('assets') }}/img/partner-3.png" alt="Parter Logo">
                            </div>
                            <!-- single slide -->
                            <div class="swiper-slide">
                                <img src="{{ asset('assets') }}/img/partner-4.png" alt="Parter Logo">
                            </div>
                            <!-- single slide -->
                            <div class="swiper-slide">
                                <img src="{{ asset('assets') }}/img/partner-5.png" alt="Parter Logo">
                            </div>
                            <!-- single slide -->
                            <div class="swiper-slide">
                                <img src="{{ asset('assets') }}/img/partner-6.png" alt="Parter Logo">
                            </div>
                            <!-- single slide -->
                            <div class="swiper-slide">
                                <img src="{{ asset('assets') }}/img/partner-1.png" alt="Parter Logo">
            ...
            <section class="ul-team ul-section-spacing">
                ...
                <div class="ul-section-vectors ul-team-vectors">
                    <img src="{{ asset('assets') }}/img/team-vector-1.png" alt="vector" class="wow animate__fadeInLeft">
                    <img src="{{ asset('assets') }}/img/team-vector-2.png" alt="vector" class="wow animate__fadeInRight">
                </div>
            </section>
            <!-- TEAM SECTION END -->
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="ul-inner-testimony">
                                    ...
                                    <div class="ul-inner-testimony-bottom">
                                        <div class="ul-inner-testimony-reviewer">
                                            <div class="reviewer-image"><img src="{{ asset('assets') }}/img/reviewer-img-2.png" alt="reviewer image"></div>
                                            <div>
                            ...
                            <div class="swiper-slide">
                                <div class="ul-inner-testimony">
                                    ...
                                    <div class="ul-inner-testimony-bottom">
                                        <div class="ul-inner-testimony-reviewer">
                                            <div class="reviewer-image"><img src="{{ asset('assets') }}/img/reviewer-img-3.png" alt="reviewer image"></div>
                                            <div>
                                                <h3 class="reviewer-name">Esther Howard</h3>
                                                <span class="reviewer-role">Web Designer</span>
                                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="ul-inner-testimony">
                                    ...
                                    <div class="ul-inner-testimony-bottom">
                                        <div class="ul-inner-testimony-reviewer">
                                            <div class="reviewer-image"><img src="{{ asset('assets') }}/img/reviewer-img-1.png" alt="reviewer image"></div>
                                            <div>
                                                <h3 class="reviewer-name">Esther Howard</h3>
                                                <span class="reviewer-role">Web Designer</span>
                                            </div>
