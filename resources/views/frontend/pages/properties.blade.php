...
<main>
        ...
        <div class="ul-breadcrumb">
            <div class="wow animate__fadeInUp">
                <h2 class="ul-breadcrumb-title">Properties</h2>
                <div class="ul-breadcrumb-nav">
                    <a href="{{route('home')}}">Home</a>
                    <span class="separator"><i class="flaticon-aro-left"></i></span>
                    <span class="current-page">Properties</span>
                </div>
            </div>
        </div>
        ...
        <div class="ul-inner-page-content-wrapper ul-projects-page-content-wrapper">
            <div class="ul-inner-page-container">
                <!-- search filters -->
                <form action="{{ route('allpropertise') }}" method="GET" class="ul-projects-search-filters">
                ...
                @if(request()->hasAny(['keyword', 'property-type', 'location', 'max-price', 'beds', 'floors', 'garages']))
                    <div class="alert alert-info wow animate__fadeInUp">
                        <strong>{{ $properties->total() }}</strong> rental properties found
                        @if(request('keyword'))
                            for "<strong>{{ request('keyword') }}</strong>"
                        @endif
                        <a href="{{ route('allpropertise') }}" class="btn btn-sm btn-outline-primary ms-2">Clear Filters</a>
                    </div>
                @endif
                    ...
                    @empty
                        <div class="col-12 text-center py-5">
                            <div class="text-muted">
                                ...
                                <h4 class="mt-3">No rental properties found</h4>
                                <p>Try adjusting your search criteria or browse all rental properties.</p>
                                <a href="{{ route('properties.rent') }}" class="btn btn-primary">View All Rentals</a>
                            </div>
                        </div>
                    @endforelse
                </div>
